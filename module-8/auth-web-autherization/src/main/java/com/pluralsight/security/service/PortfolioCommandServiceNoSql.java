...
public class PortfolioCommandServiceNoSql implements PortfolioCommandService {
	...
	private final PortfolioAccessControlRepository accessControl;
	...
	public void createNewPortfolio(String username) {
		Portfolio portfolio = portfolioRepository.save(new Portfolio(username, new ArrayList<>()));
		PortfolioAccessControl portfolioAccessControl = new PortfolioAccessControl(getUsername(), portfolio.getId(), "READ");
		this.accessControl.save(portfolioAccessControl);
	}
