...
public class UserDetailsServiceNoSql implements UserDetailsService {
	...
	public static final boolean DEFAULT_ACC_NON_EXP = true;
	public static final boolean DEFAULT_CRED_NON_EXP = true;
	public static final boolean DEFAULT_ACC_NON_LOCKED = true;
